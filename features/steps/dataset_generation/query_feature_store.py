...
from features.domain.cleaned_documents import CleanedDocument, CleanedTransactionDocument
...
def __fetch(cleaned_document_type: type[CleanedDocument], limit: int = 1) -> list[CleanedDocument]:
    ...
    try:
        ...
        _LOGGER.debug(f'Encountered exception while fetching cleaned documents. Error: {e}')
        return []
